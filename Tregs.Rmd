...
header_info <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/SDY67/Header_SDY67.xlsx")                            
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy67 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/SDY67/Study/Tab/SDY67-DR29_Tab/Tab/hai_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
...
```{r}
ggplot(na.omit(melt_response_sdy67),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```
...
sdy <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY67_Percentages.xlsx",sheet=5)
colnames(sdy)[1] <- "name"
...
ggplot(mlt_sdy67,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")
```
...
ggplot(na.omit(melt_data_sdy67),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 28)")


ggplot(na.omit(melt_data_sdy67),aes(x=responder28,y=value, color=variable))+geom_boxplot()+xlab("Response at Day28")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day28")+facet_wrap(~Age_cat)
```
...
#p1<-ggscatter(data_sdy80,x=paste0("Day_-7"),y="FoldChange",add = "reg.line", conf.int = TRUE, 
 #           cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day -7")
  p2<-ggscatter(data_sdy67,x="Day_0",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 0")
  p3<-ggscatter(data_sdy67,x="Day_3",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 3")
  p4<-ggscatter(data_sdy67,x="Day_28",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 28")
 p5<-ggscatter(data_sdy67,x="Day_75",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 75")
``` 
...
header_info <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/SDY80/Header_SDY80.xlsx",sheet=1) 
...
ggplot(na.omit(melt_response),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```
...
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy80 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY80_Percentages.xlsx",sheet=2)[,c(1:7)]
...
ggplot(mlt_sdy80,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")

```

```{r}
ggplot(na.omit(melt_data_sdy80),aes(x=variable,y=value,group=subject_accession,color=responder0))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 0)")
ggplot(na.omit(melt_data_sdy80),aes(x=variable,y=value,group=subject_accession,color=responder7))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 7)")
ggplot(na.omit(melt_data_sdy80),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 28)")

ggplot(na.omit(melt_data_sdy80),aes(x=responder0,y=value, color=variable))+geom_boxplot()+xlab("Response at Day0")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day0")+facet_wrap(~Age_cat)
ggplot(na.omit(melt_data_sdy80),aes(x=responder7,y=value, color=variable))+geom_boxplot()+xlab("Response at Day7")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day7")+facet_wrap(~Age_cat)
ggplot(na.omit(melt_data_sdy80),aes(x=responder28,y=value, color=variable))+geom_boxplot()+xlab("Response at Day28")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day28")+facet_wrap(~Age_cat)
```
...
p1<-ggscatter(data_sdy80,x=paste0("Day_-7"),y="FoldChange",add = "reg.line", conf.int = TRUE, 
  ...
  p3<-ggscatter(data_sdy80,x="Day_1",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 1")
 ...
 p5<-ggscatter(data_sdy80,x="Day_70",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 70")
```
...
```{r, inlcude=TRUE, message=FALSE, warning=FALSE}
#mod <- lmer()
```
##SDY404
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy404 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/SDY404/SDY404-DR29_Tab/Tab/hai_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
#ab_titer <- ab_titer[which(ab_titer$STUDY_TIME_COLLECTED == '0'),]
...
ggplot(na.omit(melt_response_sdy404),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```

Tregs population proportions: Plots below show the proportions of Tregs across time points. In each plot the colors indicate responder or non-responder based on ab-titer at each time point of titer. (> 40 is a responder)
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy404 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY404_Percentages.xlsx",sheet=2)[,c(1:7)]
...
ggplot(mlt_sdy404,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")
```


```{r}
ggplot(na.omit(melt_data_sdy404),aes(x=variable,y=value,group=subject_accession,color=responder0))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 0)")
ggplot(na.omit(melt_data_sdy404),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line(aes(linetype=Age_cat))+geom_point()+xlab("Day (for Cell proportion)")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points (Response based on Day 28)")

ggplot(na.omit(melt_data_sdy404),aes(x=responder0,y=value, color=variable))+geom_boxplot()+xlab("Response at Day0")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day0")+facet_wrap(~Age_cat)
ggplot(na.omit(melt_data_sdy404),aes(x=responder28,y=value, color=variable))+geom_boxplot()+xlab("Response at Day28")+ylab("Cell proportion")+ggtitle("Cell Proportions across time points for response at Day28")+facet_wrap(~Age_cat)
```
...
#p1<-ggscatter(data_sdy80,x=paste0("Day_-7"),y="FoldChange",add = "reg.line", conf.int = TRUE, 
 #           cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day -7")
  ...
  p3<-ggscatter(data_sdy404,x="Day_2",y="FoldChange",add = "reg.line", conf.int = TRUE, 
            cor.coef = TRUE, cor.method = "pearson",xlab="Cell Proportion", ylab="Ab Titer Fold Change",title = "Tregs at Day 2")
...
#This file has the list of fcs files we have
header_info <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Companion_studies_3/SDY312/Header_SDY312.xlsx",sheet=1) 
colnames(header_info)[1] <- "name"
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy312 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/Companion_studies_3/SDY312/Study/Tab/SDY312-DR29_Tab/Tab/hai_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
  #ab_titer <- ab_titer[which(ab_titer$STUDY_TIME_COLLECTED == '0'),]
...
ggplot(na.omit(melt_response_sdy312),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```
...
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy312 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY312_Tregs_proportions.xlsx",sheet=2)[,c(1:7)]
...
ggplot(mlt_sdy312,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")

```

```{r}
ggplot(na.omit(data_sdy312),aes(x=Age_cat,y=Day_0,color=responder28))+geom_boxplot()+xlab("Age")+ylab("Cell Proportion")+ggtitle("Boxplot of Cell Proportion at Day 0")
```
...
#This file has the list of fcs files we have
header_info <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/SDY514/Header_SDY514.xlsx",sheet=1) 
colnames(header_info)[1] <- "name"
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy514 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/SDY514/Study/Tab/SDY514-DR32_Tab/Tab/hai_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
  #ab_titer <- ab_titer[which(ab_titer$STUDY_TIME_COLLECTED == '0'),]
...
#ggplot(na.omit(melt_response_sdy312),aes(x=variable,y=value,group=subject_accession,color=responder0))+geom_line()
ggplot(na.omit(melt_response_sdy514),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```

Tregs population proportions: Plot below shows the proportions of Tregs. Colors indicate responder or non-responder based on ab-titer at Day 28. (> 40 is a responder)
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy514 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY514_Percentages.xlsx",sheet=3)[,c(1:7)]
...
ggplot(mlt_sdy514,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")

```

```{r}
ggplot(na.omit(data_sdy514),aes(x=Age_cat,y=Day_0,color=responder28))+geom_boxplot()+xlab("Age")+ylab("Cell Proportion")+ggtitle("Boxplot of Cell Proportion at Day 0")
```
...
fcs_meta_Data <- unique(fcs_meta_Data[,-c(3,7)])
#This file has the list of fcs files we have
header_info <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/SDY202/Header_SDY202.xlsx",sheet=1) 
colnames(header_info)[1] <- "name"
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy202 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/SDY202/Study/Tab/SDY202-DR29_Tab/Tab/hai_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
  #ab_titer <- ab_titer[which(ab_titer$STUDY_TIME_COLLECTED == '0'),]
...
#ggplot(na.omit(melt_response_sdy312),aes(x=variable,y=value,group=subject_accession,color=responder0))+geom_line()
ggplot(na.omit(melt_response_sdy202),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```

Tregs population proportions: Plot below shows the proportions of Tregs. Colors indicate responder or non-responder based on ab-titer at Day 28. (> 40 is a responder)
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy202 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY202_percentages.xlsx",sheet=2)[,c(1:7)]
...
ggplot(mlt_sdy202,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")

```

```{r}
ggplot(na.omit(data_sdy202),aes(x=Age_cat,y=Day_0,color=responder28))+geom_boxplot()+xlab("Age")+ylab("Cell Proportion")+ggtitle("Boxplot of Cell Proportion at Day 0")
```
...
```{r, include=FALSE, warning=FALSE, message=FALSE}
ab_titer_sdy739 <- read.delim("/Volumes/Samsung_T5/Immport_UH2/SDY739/Study/Tab/SDY739-DR32_Tab/Tab/neut_ab_titer_result.txt",stringsAsFactors = FALSE,sep="\t",header=TRUE)
  #ab_titer <- ab_titer[which(ab_titer$STUDY_TIME_COLLECTED == '0'),]
...
#ggplot(na.omit(melt_response_sdy312),aes(x=variable,y=value,group=subject_accession,color=responder0))+geom_line()
ggplot(na.omit(melt_response_sdy739),aes(x=variable,y=value,group=subject_accession,color=responder28))+geom_line()+geom_point()+xlab("Day")+ylab("titer")+ggtitle("Antibody response across time points")
```

Tregs population proportions: Plot below shows the proportions of Tregs. Colors indicate responder or non-responder based on ab-titer at Day 28. (> 40 is a responder)
```{r, include=FALSE, message=FALSE, warning=FALSE}
#Reading the population percentages
sdy739 <- read.xlsx("/Volumes/Samsung_T5/Immport_UH2/Results_Analysis/Tregs/SDY739_Percentages.xlsx",sheet=3)[,c(1:7)]
...
ggplot(mlt_sdy739,aes(x=Var2,y=value,fill=factor(Var1)))+geom_bar(stat="identity",width = 0.3,alpha=0.6)+xlab("Response")+ylab("Number of subjects")+scale_fill_manual(values=c("deepskyblue4","brown3"),name="Age")

```

```{r}
ggplot(data_sdy739,aes(x=Age_cat,y=Day_0,color=responder28))+geom_boxplot()+xlab("Age")+ylab("Cell Proportion")+ggtitle("Boxplot of Cell Proportion at Day 0")
```
