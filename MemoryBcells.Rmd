...
studies_dir <- file.path(paste0("./Spreadsheets/SDY144_Study"))
...
header_info <- read.xlsx("./Spreadsheets/Header_SDY144.xlsx",sheet=1)                            
...
```{r, include=FALSE}
ab_titer_sdy144 <- read.table("./Spreadsheets/SDY144_Study/SDY144-DR28_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY144_config_memB.png)
Gating hierarchy used to identify the cell populations (example: SUB118176 at Day 7)
![alt text](./figure-html/SDY144_1_memB.png)

![alt text](./figure-html/SDY144_2_memB.png)

![alt text](./figure-html/SDY144_3_memB.png)

![alt text](./figure-html/SDY144_4_memB.png)
```{r, include=FALSE}
#####Read the files########
sdy144 <- read.xlsx("./Spreadsheets/SDY144_MemoryBcells.xlsx",sheet=2)[,-1]
...
sdy <- "SDY364"
##Set tab_dir to the folder where the study files are located
studies_dir <- file.path(paste0("./Spreadsheets/SDY364_Study/"))
tab_dir <- file.path(studies_dir,"Tab")
list.files(tab_dir)
...
header_info <- read.xlsx("./Spreadsheets/Header_SDY364.xlsx",sheet=1)                            
#colnames(header_info)[1] <- "name" 
...
```{r, include=FALSE}
ab_titer_sdy364 <- read.table("./Spreadsheets/SDY364_Study/Tab/SDY364-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY364_config_memB.png)


Gating hierarchy used to identify the cell populations (example: SUB135685 at Day 1 )
![alt text](./figure-html/SDY364_1_memB.png)

![alt text](./figure-html/SDY364_2_memB.png)


![alt text](./figure-html/SDY364_3_memB.png)


![alt text](./figure-html/SDY364_4_memB.png)
```{r, include=FALSE}
#####Read the files########
sdy364 <- read.xlsx("./Spreadsheets/SDY364_MemoryBcells.xlsx",sheet=2)[,-1]
...
sdy <- "SDY368"
##Set tab_dir to the folder where the study files are located
studies_dir <- file.path(paste0("./Spreadsheets/SDY368_Study/"))
tab_dir <- file.path(studies_dir,"Tab")
list.files(tab_dir)
...
header_info <- read.table("./Spreadsheets/SDY368mapping.txt",header=T)
colnames(header_info)[1] <- "name" 
...
```{r, include=FALSE}
ab_titer_sdy368 <- read.table("./Spreadsheets/SDY368_Study/Tab/SDY368-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY368_config_memB.png)


Gating hierarchy used to identify the cell populations (example: SUB135730 at Day 28)
![alt text](./figure-html/SDY368_1_memB.png)

![alt text](./figure-html/SDY368_2_memB.png)


![alt text](./figure-html/SDY368_3_memB.png)


![alt text](./figure-html/SDY368_4_memB.png)

Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy368 <- read.xlsx("./Spreadsheets/SDY368_MemoryBcells.xlsx",sheet=2)[,-1]
...
sdy <- "SDY387"
##Set tab_dir to the folder where the study files are located
studies_dir <- file.path(paste0("./Spreadsheets/SDY387_Study/"))
tab_dir <- file.path(studies_dir,"Tab")
list.files(tab_dir)
...
```{r, include=FALSE}
fcs_meta_Data <- unique(fcs_meta_Data[,-c(2,3,5)])
header_info <- read.table("./Spreadsheets/SDY387mapping.txt",header=T)
colnames(header_info)[1] <- "name" 
...
```{r, include=FALSE}
ab_titer_sdy387 <- read.table("./Spreadsheets/SDY387_Study/Tab/SDY387-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY387_config_memB.png)


Gating hierarchy used to identify the cell populations (example: SUB135864 at Day 7)
![alt text](./figure-html/SDY387_1_memB.png)

![alt text](./figure-html/SDY387_2_memB.png)


![alt text](./figure-html/SDY387_3_memB.png)


![alt text](./figure-html/SDY387_4_memB.png)

Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy387 <- read.xlsx("./Spreadsheets/SDY387_MemoryBcells.xlsx",sheet=2)[,-1]
...
sdy <- "SDY372"
##Set tab_dir to the folder where the study files are located
studies_dir <- file.path(paste0("./Spreadsheets/SDY372_Study/"))
tab_dir <- file.path(studies_dir,"Tab")
list.files(tab_dir)
...
```{r, include=FALSE}
fcs_meta_Data <- unique(fcs_meta_Data[,-c(2,3,5)])
header_info <- read.xlsx("./Spreadsheets/Header_SDY372.xlsx")
colnames(header_info)[1] <- "name" 
...
Antibody titer for SDY387: Responders vs Non-responders: titer >= 40 are responders and titer < 40 are non-responders at Visit 0. Fold change is calculated as $\frac{Geometric mean of Ab titer of all strains on Day 28}{Geometric mean of Ab titer of all strains on Day 0}$.
```{r, include=FALSE}
ab_titer_sdy372 <- read.table("./Spreadsheets/SDY372_Study/Tab/SDY372-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY372_config_memB.png)


Gating hierarchy used to identify the cell populations (example: SUB135772 at Day 7)
![alt text](./figure-html/SDY372_1_memB.png)

![alt text](./figure-html/SDY372_2_memB.png)


![alt text](./figure-html/SDY372_3_memB.png)


![alt text](./figure-html/SDY372_4_memB.png)

Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy372 <- read.xlsx("./Spreadsheets/SDY372_MemoryBcells.xlsx",sheet=5)[,-1]
...
sdy <- "SDY180"
##Set tab_dir to the folder where the study files are located
studies_dir <- file.path(paste0("./Spreadsheets/SDY180_Study/"))
tab_dir <- file.path(studies_dir,"Tab")
list.files(tab_dir)
...
```{r, include=FALSE}
fcs_meta_Data <- unique(fcs_meta_Data[,-c(2,3,5)])
header_info <- read.xlsx("./Spreadsheets/Headers_SDY180.xlsx")
colnames(header_info)[1] <- "name" 
...
```{r, include=FALSE}
ab_titer_sdy180 <- read.table("./Spreadsheets/SDY180_Study/Tab/SDY180-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./figure-html/SDY180_config_memB.png)


Gating hierarchy used to identify the cell populations (example: SUB119262 at Day -7, i.e. 7 days prior vaccination)
![alt text](./figure-html/SDY180_1_memB.png)

![alt text](./figure-html/SDY180_2_memB.png)


![alt text](./figure-html/SDY180_3_memB.png)


![alt text](./figure-html/SDY180_4_memB.png)

Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy180 <- read.xlsx("./Spreadsheets/SDY180_MemoryBcells.xlsx",sheet=5)[,-1]
