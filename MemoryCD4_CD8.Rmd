...
header_info <- read.xlsx("./Spreadsheets/Header_SDY144.xlsx",sheet=1)[,-4]                            
...
```{r, include=FALSE}
ab_titer_sdy144 <- read.table("./Spreadsheets/SDY144_Study/Tab/SDY144-DR28_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./input_files/sdy144_config_memT.png)

Gating hierarchy used to identify the cell populations (example: SUB118176 at Day 28)
![alt text](./input_files/SDY144_1_memT.png)
![alt text](./input_files/SDY144_2_memT.png)
![alt text](./input_files/SDY144_3_memT.png)
![alt text](./input_files/SDY144_4_memT.png)

### Cell Proportions
```{r, include=FALSE}
#####Read the files########
sdy144 <- read.xlsx("./Spreadsheets/SDY144_MemoryTcells.xlsx",sheet=2)[,-1]
...
![alt text](./input_files/SDY364_config_memT.png)

Gating hierarchy used to identify the cell populations (example: SUB135676 at Day 7)
![alt text](./input_files/SDY364_1_memT.png)
![alt text](./input_files/SDY364_2_memT.png)

![alt text](./input_files/SDY364_3_memT.png)

![alt text](./input_files/SDY364_4_memT.png)

###Cell Proportions
```{r, include=FALSE}
#####Read the files########
sdy364 <- read.xlsx("./Spreadsheets/SDY364_MemoryTcells.xlsx",sheet=2)[,-1]
...
```{r, include=FALSE}
ab_titer_sdy368 <- read.table("./Spreadsheets/SDY368_Study/Tab/SDY368-DR29_Tab/Tab/neut_ab_titer_result.txt",sep = "\t", header=TRUE)
...
![alt text](./input_files/SDY368_config_memT.png)
Gating hierarchy used to identify the cell populations (example: SUB135723 at Day 1)
![alt text](./input_files/SDY368_1_memT.png)

![alt text](./input_files/SDY368_2_memT.png)

![alt text](./input_files/SDY368_3_memT.png)

![alt text](./input_files/SDY368_4_memT.png)
###Cell Proportions:
Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy368 <- read.xlsx("./Spreadsheets/SDY368_MemoryTcells.xlsx",sheet=2)[,-1]
...
```{r, include=FALSE}
ab_titer_sdy387 <- read.table("./Spreadsheets/SDY387_Study/Tab/SDY387-DR29_Tab/Tab/neut_ab_titer_result.txt",sep = "\t", header=TRUE)
...
![alt text](./input_files/SDY387_config_memT.png)
Gating hierarchy used to identify the cell populations (example: SUB135881 at Day 90)
![alt text](./input_files/SDY387_1_memT.png)

![alt text](./input_files/SDY387_2_memT.png)

![alt text](./input_files/SDY387_3_memT.png)

![alt text](./input_files/SDY387_4_memT.png)

###Cell Proportions:
Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy387 <- read.xlsx("./Spreadsheets/SDY387_MemoryTcells.xlsx",sheet=3)[,-1]
...
```{r, include=FALSE}
fcs_meta_Data <- unique(fcs_meta_Data[,-c(2,3,5)])
header_info <- read.xlsx("./Spreadsheets/Header_SDY404.xlsx",sheet=1)
colnames(header_info)[1] <- "name" 
...
```{r, include=FALSE}
ab_titer_sdy404 <- read.table("./Spreadsheets/SDY404_Study/Tab/SDY404-DR29_Tab/Tab/hai_result.txt",sep = "\t", header=TRUE)
...
![alt text](./input_files/SDY404_config_memT.png)
Gating hierarchy used to identify the cell populations (example: SUB120460 at Day 28)
![alt text](./input_files/SDY404_1_memT.png)

![alt text](./input_files/SDY404_2_memT.png)
![alt text](./input_files/SDY404_3_memT.png)
![alt text](./input_files/SDY404_4_memT.png)
###Cell Proportions:
Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
sdy404 <- read.xlsx("./Spreadsheets/SDY404_MemoryTcells.xlsx",sheet=2)[,-1]
...
##Summary
Table below shows time points and virus strains used in each study.
...
Plotting cell proportions across studies that common virus strains. Only common time-points are used for visualization. The points indicate responder or non-responder (based on ab-titer on Day 28 or Day 30). Plots show variability across studies.
```{r,warning=FALSE,message=FALSE,fig.height = 8, fig.width = 10,echo=FALSE, results=TRUE}
