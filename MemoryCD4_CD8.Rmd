---
title: "MemoryCD4+ and CD8+"
author: "Aishwarya Mandava"
date: "2/25/2020"
output:
  html_document:
    css: style.css
...
![alt text](SDY144_config.png)

Gating hierarchy used to identify the cell populations (example: SUB118176 at Day 28)
![alt text](SDY144_1.png)
![alt text](SDY144_2.png)
![alt text](SDY144_3.png)
![alt text](SDY144_4.png)
...
![alt text](SDY364_config.png)

Gating hierarchy used to identify the cell populations (example: SUB135676 at Day 7)
![alt text](SDY364_1.png)
![alt text](SDY364_2.png)

![alt text](SDY364_3.png)

![alt text](SDY364_4.png)
...
![alt text](SDY368_config.png)
Gating hierarchy used to identify the cell populations (example: SUB135723 at Day 1)
![alt text](SDY368_1.png)

![alt text](SDY368_2.png)

![alt text](SDY368_3.png)

![alt text](SDY368_4.png)
###Cell Proportions:
...
![alt text](SDY387_config.png)
Gating hierarchy used to identify the cell populations (example: SUB135881 at Day 90)
![alt text](SDY387_1.png)

![alt text](SDY387_2.png)

![alt text](SDY387_3.png)

![alt text](SDY387_4.png)
...
![alt text](SDY404_config.png)
Gating hierarchy used to identify the cell populations (example: SUB120460 at Day 28)
![alt text](SDY404_1.png)

![alt text](SDY404_2.png)
![alt text](SDY404_3.png)
![alt text](SDY404_4.png)
###Cell Proportions:
Colors indicate responder or non-repsonder based on the titer values at Day 0. 
```{r, include=FALSE}
#####Read the files########
