...
![B-cell panel gating hierarchy](./input_files/SDY67_Bcell.png)
...
![alt text](./input_files/SDY67_DCells1.png)
![alt text](./input_files/SDY67_DCells2.png)
![alt text](./input_files/SDY67_DCells3.png)
#### B) Metadata
```{r, include=FALSE, echo=FALSE}
sdy <- "SDY67"
##Set tab_dir to the folder where the study files are located
